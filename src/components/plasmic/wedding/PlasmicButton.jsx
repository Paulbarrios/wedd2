...
import sty from "./PlasmicButton.module.css"; // plasmic-import: bsHYMTqsewT/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: oOz0J5J9568/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: CHREPQbnkEZ/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__kN2G2)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__yEkf7)}
                role={"img"}
              />
            ),
